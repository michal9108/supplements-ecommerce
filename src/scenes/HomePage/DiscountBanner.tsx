...
const DiscountBanner = () => {
  return (
    ...
    >
      <section
        id=""
        className="slideshow custom-slideshow relative overflow-hidden min-h-[var(--min-h-mobile)] md:min-h-[var(--min-h)]   pt-0 pb-0"
      ...
      >
            ...
            ><img src={BannerImg} className="w-full h-full object-cover"/>
              ...
              <figcaption className="absolute z-10 inset-0 lg:w-4/6 md:w-5/6 sm:w-5/6 xs:w-5/6 xxs:w-5/6 h-full mx-auto md:px-6 py-12">
                <div className="container h-full w-full flex flex-col justify-end items-start text-left">
                  <div className="max-w-2xl grid gap: 8px">
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row sm:justify-start text-left ">
                    <ButtonLink
                    //   onClick={}
                    to={"/productpage"}
