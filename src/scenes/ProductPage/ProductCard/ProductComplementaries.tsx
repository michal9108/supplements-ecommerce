...
export default function ProductComplementaries() {
  return (
  
      <div className="flex justify-around py-4 max-sm:flex-col max-md:flex-wrap md:my-2 w-full">
        ...
        <div className="  flex gap-3  border-box  mx-auto  ">
          <div className="flex my-3 p-1 border-dotted rounded-lg border-3 border-secondary-500 ">
            ...
            <div className="flex">
              <p className="text-gray-900 text-md font-semibold my-auto">
                Free Shipping
              </p>
            </div>
          </div>
