...
export default function ProductProofs() {
  ...
  return (
    ...
    <> 
    {isAbovePhoneScreens ? (<div className="flex justify-center py-4  max-sm:flex-wrap md:my-2 mx-auto w-5/6">
       ...
       <div className="  flex gap-3  border-box  mx-auto  ">
         <div className="flex my-3 p-1 border-dotted rounded-lg border-3 border-secondary-500 ">
           ...
           <div className="flex">
             <p className="text-gray-900 text-md  max-xs:text-xs font-semibold my-auto">
               Free Shipping
             </p>
           </div>
         </div>
       </div>
       <div className="  flex gap-3  max-sm:flex-wrap border-box mx-auto  ">
      ...
      <div className="mt-12 flex flex-row  flex-wrap justify-center">
        <div className=" flex   gap-3  border-box  mx-auto ">
         <div className="flex my-1 p-1 border-dotted rounded-lg border-3 border-secondary-500 ">
           <div className="rounded-full border-1 border-gray-100 bg-primary-100   my-auto mx-2">
             <svg
               className="w-5 h-5"
               xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 48 48"
